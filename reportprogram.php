...
?>    
    ...
    $sql="SELECT p.pro_risk_name,COUNT(r.risk_id) as numx
            from risk r
            LEFT OUTER JOIN pro_risk p on p.pro_risk_id = r.pro_risk_id
            GROUP BY r.pro_risk_id";   
?>               

<div class="panel-heading" ><h4><i class="glyphicon glyphicon-list-alt" ></i> รายงานอุบัติการแยกตามโปรแกรมความเสี่ยงหลัก </h4></div>
                    ...
                    <div class="datagrid">
                                    ...
                                    <table class="table table-bordered" id="datatable" style="width:80%" align="center" cellspacing="0" cellpadding="2">
                                            <tr class="info">
                                                ...
                                                <td align="center">จำนวนอุบัติการณ์</td>                                                  
                                            </tr>
