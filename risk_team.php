...
<div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> ทีมคร่อมสายงาน </h4> </div>
<div class="panel-body">   
    <div>
        <a class="btn btn-primary" href="risk_team_form.php" role="button">เพิ่ม</a>
    </div>
                        ...
                        <div class="row">
                                    <table class="table table-bordered" cellspacing="0" cellpadding="2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>       
                                                    <a href="risk_team_form.php?team_id=<?php echo($record[0]);?>">แก้ไข</a>                                                    
                                                </td>                                                
