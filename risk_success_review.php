...
<?php
    if(isset($_GET['risk_id'])){
        ...
        $action_review="risk_update_review.php";
...
?>
                ...
                <section class="content">             
                            <div class="panel panel-info">
                            <div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> แสดงรายงานเหตุการณ์ <?php echo $risktitle; echo "รหัส : "; echo $risk_id;?></h4></div>
                            <div class="panel-body">  
                                    ...
                                    <form action="<?php echo($action_repeat);?>" method="post" enctype="multipart/form-data" name="risk_form_repeat" >
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="edit_dep" id="born" style="width:350px;" readonly="true" >
                                                    ...
                                                    {
                                                    ?>
                                                    <option <?php if($edit_dep_id==$record8["dep_id"]) echo 'selected';?> value="<?php echo $record8["dep_id"];?>"><?php echo $record8["dep_id"]." - ".$record8["dep_name"];?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>                                                
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="edit_team" id="born" style="width:350px;" readonly="true" >
                                                    <option value="">Select</option>
                                                    <?php
                                                    $sql="SELECT * from team";
                                                    require('connect.php');
                                                    ...
                                                    {
                                                    ?>
                                                    <option <?php if($edit_team_id==$record9["team_id"]) echo 'selected';?> value="<?php echo $record9["team_id"];?>"><?php echo $record9["team_id"]." - ".$record9["team_name"];?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">                                    
                                                ...
                                                <textarea class="form-control" name="method_id" cols="20" rows="2" style="width:400px;" readonly="true" ><?php echo($detail_prob);?></textarea>                                                                                                
                                            </div>
                                        </div>
                                        </div>
                                        </div> 
...
<!--                                                <input  class="form-control" name="files" type="text" value="<?php echo($files);?>" style="width:400px;" readonly="true">-->
                                                <?php if($files !=''){?>
                                                    <a class="btn btn-primary" href="./<?php echo($files);?>" target="_blank">ดูเอกสารแนบ</a>
                                                <?php } else{
                                                    echo 'ไม่พบไฟล์';
                                                }?>
                    ...
                    <div class="panel panel-warning">
                            <div class="panel-heading"><h5><i class="glyphicon glyphicon-tasks"></i> ส่วนทบทวนความเสี่ยง โดย ศูนย์บริหารความเสี่ยง </h5></div>
                                <div class="panel-body">
                                    <form action="<?php echo($action_review);?>" method="post" enctype="multipart/form-data" name="risk_form_repeat" >
                                        <input name="riskid" type="hidden" value="<?php echo $risk_id?>">
                                        <input name="uid" type="hidden" value="<?php echo $uid?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                วันที่รับเรื่องทบทวน :
                                                </div>
                                                <input  class="form-control" name="review_date" type="date" value="<?php echo($date_review);?>" style="width:170px;" readonly="true">

                                                <div class="input-group-addon">
                                                ประเภทการทบทวน :
                                                </div>
                                                <select class="form-control" name="review_id" id="born" style="width:350px;"  readonly="true">
                                                    <option value="">Select</option>
                                                    <?php
                                                    $sql="SELECT * from review";
                                                    require('connect.php');
                                                    while($record10=mysqli_fetch_array($result))
                                                    {
                                                    ?>
                                                    <option <?php if($review_id==$record10["review_id"]) echo 'selected';?> value="<?php echo $record10["review_id"];?>"><?php echo $record10["review_id"]." - ".$record10["review_name"];?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>                                                
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="follow_id" id="born" style="width:350px;"  readonly="true">
                                                    <option value="">Select</option>
                                                    <?php
                                                    $sql="SELECT * from follow";
                                                    require('connect.php');
                                                    while($record11=mysqli_fetch_array($result))
                                                    {
                                                    ?>
                                                    <option <?php if($follow_id==$record11["follow_id"]) echo 'selected';?> value="<?php echo $record11["follow_id"];?>"><?php echo $record11["follow_id"]." - ".$record11["follow_name"];?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">                                    
                                                ...
                                                <textarea class="form-control" name="review_detail" cols="20" rows="2" style="width:400px;"  readonly="true"><?php echo($review_detail);?></textarea>                                                                                                
                                            </div>
                                        </div>
                                        </div>
                                        </div>                                     
