    ...
    if($authenrole<1){
        ...
        if($userlevel==1 or $userlevel==3 or $userlevel==5){
            ...
            if($userlevel==5){
                ...
                $sql.=" where risk.edit_dep_id is not null and risk.follow_id is null or risk.follow_id in('2','3')";
                ...
                <div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> รายการความเสี่ยงรอทบทวน </h4></div>
                <div class="panel-body">    
                    <form action="risk_review.php" method="get" name="search_form" >
                                                    ...
                                                    <table class="table table-bordered" cellspacing="0" cellpadding="2">
                                                            ...
                                                            <tr bgcolor="<?php if($record[9]!=""){echo "#E9967A";}?>">
                                                                <td>
                                                                    ...
                                                                    <a class="glyphicon glyphicon-log-in" href="risk_review_form.php?risk_id=<?php echo($record[0]);?>"></a>    
                                                                </td>                                                
