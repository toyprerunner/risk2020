                                    ...
                                    <form action="<?php echo($action_review);?>" method="post" enctype="multipart/form-data" name="risk_form_repeat" >
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="review_id" id="born" style="width:350px;"  >
                                                    <option value="">Select</option>
                                                    <?php
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="follow_id" id="born" style="width:350px;"  >
                                                    <option value="">Select</option>
                                                    <?php
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">                                    
                                                ...
                                                <textarea class="form-control" name="review_detail" cols="20" rows="2" style="width:400px;"  ><?php echo($review_detail);?></textarea>                                                                                                
                                            </div>
                                        </div>
                                        </div>
                                        </div>
