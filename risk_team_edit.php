...
?> 
    ...
    $sql="SELECT
        ...
        inner join profile on profile.user_id = risk.user_id
    ...
    $sql.=" and risk.follow_id is null and risk.review_id is null ORDER BY risk.date_stamp desc";

?>           
<div class="panel-body">
<div class="panel panel-info">
<div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> รายการความเสี่ยงทีมคร่อมสายงาน </h4></div>
<div class="panel-body">    
    <form action="risk_team_edit.php" method="get" name="search_form" >
