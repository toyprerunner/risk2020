...
<?php
    ...
    if($authenrole<1){
        ...
        if($userlevel==3 or $userlevel==3 or $userlevel==5){
            require 'navigator.php';
            if($userlevel==3){
            $uid=$_SESSION['authen']['uid'];
            $udep_id = $_SESSION['authen']['udept'];
            ...
            $sql.=" where risk.edit_user_id is null and risk.follow_id is null and risk.dep_id = '$udep_id'";
            ...
            $sql.=" where risk.edit_user_id is null and risk.follow_id is null";
            ...
            <div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> รายการความเสี่ยงรอลงทะเบียน </h4></div>
            <div class="panel-body">    
                <form action="repeatlist.php" method="get" name="search_form" >
                                                ...
                                                <table class="table table-bordered" cellspacing="0" cellpadding="2">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <a class="glyphicon glyphicon-log-in" href="risk_repeat.php?risk_id=<?php echo($record[0]);?>"></a>    
                                                            </td>                                                
