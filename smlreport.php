...
?>    
    ...
    $sql="SELECT SUM(risk.severity_level BETWEEN 'A' and 'C') as ssmall,
            SUM(risk.severity_level BETWEEN 'D' and 'F') as smedium,
            SUM(risk.severity_level BETWEEN 'G' and 'I') as shiegth
            from risk";   
?>               

<div class="panel-heading" ><h4><i class="glyphicon glyphicon-list-alt" ></i> รายงานอุบัติการแยกระดับความรุนแรง น้อย ปานกลาง มาก </h4></div>
    ...
    <div id="container" style="width:80%"></div>
                    <div class="datagrid">
                                    ...
                                    <table class="table table-bordered" id="datatable" style="width:80%" align="center" cellspacing="0" cellpadding="2">
                                            <tr class="info">
                                                <td align="center">#</td>
                                                <td align="center">ความรุนแรง A-C</td>
                                                <td align="center">ความรุนแรง D-F</td>  
                                                <td align="center">ความรุนแรง G-I</td>  
                                            </tr>
