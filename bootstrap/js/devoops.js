...
function MorrisDashboard(){
	...
	Morris.Donut({
		...
		data: [
			{value: 10, label: 'ยังไม่ตอบรับ', formatted: '1' },
			{value: 90, label: 'ตอบรับแล้ว', formatted: '4' }
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		...
		// แสดงหน้าแรก กรณี เป็น index.php
		ajax_url = 'ajax/page_dashboard.php';
	}
	...
	$('#screen_unlock').on('mouseover', function(){
		...
		var button = $('<div class="text-center"><a href="index.php" class="btn btn-primary">Unlock</a></div>');
