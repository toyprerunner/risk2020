...
?> 
<?php $sql="SELECT * from setup";
    require('connect.php');
?>
    
<div class="panel-body">
<div class="panel panel-info">
<div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> Risk Line Token </h4> </div>
<div class="panel-body">   
    <div>
        <a class="btn btn-primary" href="risk_linetoken.php" role="button">เพิ่ม</a>
    </div>
                        ...
                        <div class="row">
                                    <table class="table table-bordered" cellspacing="0" cellpadding="2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>       
                                                    <a href="risk_linetoken.php?linetoken">แก้ไข</a>                                                    
                                                </td>                                                
