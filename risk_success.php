    ...
    if($authenrole<1){
        ...
        if($userlevel==1 or $userlevel==3 or $userlevel==5){
            ...
            if($userlevel == 1 or $userlevel ==3){
                ...
                $sql.=" where risk.edit_dep_id is not null and risk.follow_id = 1 and risk.review_id=1 and risk.dep_id='$userdep'";
...
<div class="panel-heading"><h4><i class="glyphicon glyphicon-list-alt"></i> รายการความเสี่ยงทบทวนเสร็จ </h4></div>
<div class="panel-body">    
    <form action="risk_success.php" method="get" name="search_form" >
                    ...
                    <div class="row">
                                    <table class="table table-bordered" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr bgcolor="<?php if($record[9]!=""){echo "#E9967A";}?>">
                                                <td>
                                                    <a class="glyphicon glyphicon-eye-open" href="risk_success_review.php?risk_id=<?php echo($record[0]);?>"></a>                                                    
                                                </td>                                                
