...
?>    
    ...
    $sql="SELECT r.severity_level,COUNT(r.risk_id) as numx
            from risk r
            WHERE r.clinic_id = 2
            GROUP BY r.severity_level";   
?>               

<div class="panel-heading" ><h4><i class="glyphicon glyphicon-list-alt" ></i> รายงานอุบัติการแยกตามระดับความรุนแรงประเภท Specific clinical risk </h4></div>
