    ...
    if($authenrole<1){
        ...
        if($userlevel==1 or $userlevel==3 or $userlevel==5){
            ...
            if($userlevel==5){
                ...
                <div class="panel-body">    
                    <form action="reportrisk.php" method="get" name="search_form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">                                    
                            ...
                            <div class="input-group-addon">  		
                                <a class="btn btn-primary" name="btnExport" type="button" value="Export" href="exportexcel.php?str=<?php echo $stdate;?>&stp=<?php echo $endate;?>&keyword=<?php echo $keyword;?>">Export Excel</a>
                            </div>
